namespace MiniProject_VerifiedProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MiniProject_VerifiedProject.DataAccesLayer.DataContext>
    {
        ...
        protected override void Seed(MiniProject_VerifiedProject.DataAccesLayer.DataContext context)
        {
            ...
            Punctuation seedPunctuation1 = new Punctuation { Sequence = "Hello World!" };
            Punctuation seedPunctuation2 = new Punctuation { Sequence = "Hi! How are you?" };
            Punctuation seedPunctuation3 = new Punctuation { Sequence = "My name is Jeff." };
            Punctuation seedPunctuation4 = new Punctuation { Sequence = "And then he asked: Who are you? And what are you doing here?" };
            Punctuation seedPunctuation5 = new Punctuation { Sequence = "I don't like this, by this I mean the weather; I'd rather be in Spain." };
            ...
            Color2Word seedColor2Word4 = new Color2Word { ColorName = "Orange", ColorHex = "#ffffff" };
            Color2Word seedColor2Word5 = new Color2Word { ColorName = "Yellow", ColorHex = "#000000" };
